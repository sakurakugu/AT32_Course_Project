...
typedef struct
{
	...
	lv_obj_t *home_app2;
	bool home_app2_del;
	lv_obj_t *home_app2_status_bar;
	lv_obj_t *home_app2_wifi;
	lv_obj_t *home_app2_voice_on;
	lv_obj_t *home_app2_voice_off;
	lv_obj_t *home_app2_time;
	lv_obj_t *home_app2_date;
	...
	lv_obj_t *status_app;
	bool status_app_del;
	lv_obj_t *status_app_slider_1;
	lv_obj_t *status_app_sw_1;
	lv_obj_t *weather_app;
	bool weather_app_del;
	lv_obj_t *weather_app_status_bar;
	lv_obj_t *weather_app_wifi;
	lv_obj_t *weather_app_voice_on;
	lv_obj_t *weather_app_voice_off;
	lv_obj_t *weather_app_time;
	lv_obj_t *weather_app_date;
	...
	lv_obj_t *music_app;
	bool music_app_del;
	lv_obj_t *music_app_status_bar;
	lv_obj_t *music_app_wifi;
	lv_obj_t *music_app_voice_on;
	lv_obj_t *music_app_voice_off;
	lv_obj_t *music_app_time;
	lv_obj_t *music_app_date;
	...
	lv_obj_t *smart_home_app_status_bar;
	lv_obj_t *smart_home_app_wifi;
	lv_obj_t *smart_home_app_voice_on;
	lv_obj_t *smart_home_app_voice_off;
	lv_obj_t *smart_home_app_time;
	lv_obj_t *smart_home_app_date;
	...
	lv_obj_t *calculator_app_status_bar;
	lv_obj_t *calculator_app_wifi;
	lv_obj_t *calculator_app_voice_on;
	lv_obj_t *calculator_app_voice_off;
	lv_obj_t *calculator_app_time;
	lv_obj_t *calculator_app_date;
	...
	lv_obj_t *deepseek_app_wifi;
	lv_obj_t *deepseek_app_voice_on;
	lv_obj_t *deepseek_app_voice_off;
	lv_obj_t *deepseek_app_time;
	lv_obj_t *deepseek_app_date;
	...
	lv_obj_t *setting_app_status_bar;
	lv_obj_t *setting_app_wifi;
	lv_obj_t *setting_app_voice_on;
