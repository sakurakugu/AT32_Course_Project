...
typedef struct
{
	...
	lv_obj_t *home_app1_clock_app_icon;
	lv_obj_t *home_app1_clock_app_icon_label;
	...
	lv_obj_t *home_app2_minecraft_icon_label;
	...
	lv_obj_t *music_app_music_next_song_btn;
	lv_obj_t *music_app_music_next_song_btn_label;
	lv_obj_t *music_app_music_player_or_pause_btn;
	lv_obj_t *music_app_music_player_or_pause_btn_label;
	lv_obj_t *music_app_music_prev_song_btn;
	lv_obj_t *music_app_music_prev_song_btn_label;
	...
	lv_obj_t *clock_app;
	bool clock_app_del;
	lv_obj_t *clock_app_clock_page;
	lv_obj_t *clock_app_clock_page_sidebar_page;
	lv_obj_t *clock_app_clock_page_subpage_1;
	lv_obj_t *clock_app_clock_page_cont_1;
	lv_obj_t *clock_app_clock_page_label_1;
	lv_obj_t *clock_app_clock_page_subpage_2;
	lv_obj_t *clock_app_clock_page_cont_2;
	lv_obj_t *clock_app_clock_page_label_2;
	lv_obj_t *clock_app_clock_page_subpage_3;
	lv_obj_t *clock_app_clock_page_cont_3;
	lv_obj_t *clock_app_clock_page_label_3;
	lv_obj_t *clock_app_clock_page_subpage_4;
	...
	lv_obj_t *minecraft_app;
	bool minecraft_app_del;
	lv_obj_t *minecraft_app_back_btn;
	lv_obj_t *minecraft_app_back_btn_label;
	lv_obj_t *link_game_app;
	bool link_game_app_del;
	lv_obj_t *link_game_app_back_btn;
...
LV_IMG_DECLARE(_link_game_app_alpha_80x80);
LV_IMG_DECLARE(_minecraft_icon_alpha_80x80);
